...
public class LoginTc1 {
	...
	{
		login.enterMail("madantech1994@gmail.com");
		login.enterPassword("Maddy@1994");
		login.clickSignInBtn();
		System.out.println("sign in btn is clicked");


		File source =((TakesScreenshot)driver).getScreenshotAs(OutputType.FILE);
		File dest = new File("D:\\madan Project/img1.jpg");
		FileUtils.copyFile(source, dest);
		System.out.println("Screenshot Captured");



		String actualPasswrd = "Maddy@1994";
		String expectedPasswrd = "Maddy@1994";
